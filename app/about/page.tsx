  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <main className="flex-1">
        <section className="w-full pt-12 md:pt-24 lg:pt-32 border-y pb-10 h-full items-center justify-center">
          <div className="container h-full px-4 md:px-6 space-y-10 xl:space-y-16">
